...
. **Deploy your enhanced workshop**:
+
[source,sh]
----
# Build and deploy with AI backend
...
The `deploy-backend.sh` script provides an automated way to deploy your workshop with AI assistant to Kubernetes/OpenShift.
